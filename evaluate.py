...
def generate_golden_dataset(
    ...
    if llm_enabled:
        ...
        # instead of replaying a fixed, domain-templated prefix. No deterministic seeding or
        # resume/model-card/project hardcoding is applied here.
        candidates: list[dict[str, str]] = []
        for node in (question_nodes or list(nodes)):
            try:
